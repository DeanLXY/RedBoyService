...
public class SearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			if (searchkey == null || searchkey.equals("")) {
				DefaultUtils.defalutError(response, "keyword不能为空!");
				return;
			}
	...
	private void data(HttpServletRequest request, HttpServletResponse response) {
		...
		List<Map<String, Object>> productList = daoImpl.getProductList(
				searchkey, page, pageNum, orderby);
